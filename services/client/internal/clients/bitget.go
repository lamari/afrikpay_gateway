...
// GetStats returns statistics from all resilience components
// Deprecated: Resilience is now handled by Temporal workflows
func (c *BitgetClient) GetStats() map[string]interface{} {
...
// ResetStats resets statistics for all resilience components
// Deprecated: Resilience is now handled by Temporal workflows
func (c *BitgetClient) ResetStats() {
...
func (c *BitgetClient) GetResilienceStats() *models.ResilienceStats {
...
func (c *BitgetClient) ResetResilienceStats() {
